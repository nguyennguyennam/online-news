...
const rawData = [
  {
    ...
    status: "approved",
    imageUrl:
      "https://ichef.bbci.co.uk/ace/ws/800/cpsprodpb/05fa/live/89bc72d0-ad37-11ef-8ab9-9192db313061.png.webp",
    summary: "aklsfjalksfalf",
    content:
      "Phạm đình khôi sạdksahdsakjdhaskajfhsakfjsah ádjkhsadksajdhdsadkjsahdsakdj sạkdhaskdjsahdksajdhsa jkasdhsakjdhsadkjh",
    author: "Pham A",
  },
  {
    id: 2,
    ...
    status: "pending",
    imageUrl:
      "https://ichef.bbci.co.uk/ace/ws/800/cpsprodpb/fae3/live/ab3bbe70-ad46-11ef-bdf5-b7cb2fa86e10.jpg.webp",
    summary: "aklsfjalksfalf",
    content:
      "Phạm đình khôi sạdksahdsakjdhaskajfhsakfjsah ádjkhsadksajdhdsadkjsahdsakdj sạkdhaskdjsahdksajdhsa jkasdhsakjdhsadkjh",
    author: "Pham E",
  },
  {
    ...
    status: "rejected",
    imageUrl:
      "https://ichef.bbci.co.uk/ace/ws/800/cpsprodpb/3c5e/live/4f65d9a0-ab6b-11ef-8ab9-9192db313061.png.webp",
    summary: "aklsfjalksfalf",
    content:
      "Phạm đình khôi sạdksahdsakjdhaskajfhsakfjsah ádjkhsadksajdhdsadkjsahdsakdj sạkdhaskdjsahdksajdhsa jkasdhsakjdhsadkjh",
    author: "Pham B",
  },
  {
    ...
    status: "unapproved",
    imageUrl:
      "https://ichef.bbci.co.uk/ace/ws/800/cpsprodpb/1f27/live/40ec5670-aca0-11ef-bdf5-b7cb2fa86e10.jpg.webp",
    summary: "aklsfjalksfalf",
    content:
      "Phạm đình khôi sạdksahdsakjdhaskajfhsakfjsah ádjkhsadksajdhdsadkjsahdsakdj sạkdhaskdjsahdksajdhsa jkasdhsakjdhsadkjh",
    author: "Pham C",
  },
  {
    ...
    status: "approved",
    imageUrl:
      "https://ichef.bbci.co.uk/ace/ws/800/cpsprodpb/997d/live/703ffe00-ac5e-11ef-a4fe-a3e9a6c5d640.jpg.webp",
    summary: "aklsfjalksfalf",
    content:
      "Phạm đình khôi sạdksahdsakjdhaskajfhsakfjsah ádjkhsadksajdhdsadkjsahdsakdj sạkdhaskdjsahdksajdhsa jkasdhsakjdhsadkjh",
    author: "Pham D",
...
router.get("/postlist", (req, res) => {
  ...
  const unapprovedPosts = rawData.filter(
    (post) => post.status === "unapproved",
  );
