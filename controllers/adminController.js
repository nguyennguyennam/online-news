...
export async function RenderAdminDashboard(res, req){
    ...
    res.render('../admin-pages/dashboard',{
        posts, editors, writers, subscribers, categories
    })
}
